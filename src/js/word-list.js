import { appendFormattedDictionaryText } from './dictionary-display.js';
...
export function createWordList({ summaryEl, bodyEl, toggleBtn, wrapEl, previewLimit }) {
  ...
  function createRows(items) {
    ...
    items.forEach((pair) => {
      ...
      appendFormattedDictionaryText(greekCell, pair.greek, { highlightGreekEndings: true });
      appendFormattedDictionaryText(translationCell, pair.translation);
